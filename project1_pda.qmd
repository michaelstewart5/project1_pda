...
anovamodel1 <- aov(time_min ~ flag, data = cleaned_df)
anovamodel1

anovamodel2 <- aov(time_min ~ age_bin, data = cleaned_df)
anovamodel2 

anovamodel3 <- aov(time_min ~ sex, data = cleaned_df)
anovamodel3
...
transposed_summary <- weather_summary_race %>%
  pivot_longer(cols = -race, names_to = "Weather Variable", values_to = "Value") %>%
...
gtsave(
  ...
  filename = "transposed_weather_summary.png"
)
```
